...
public interface ResearchInputIngredient<T> {
     ...
     * @return this
     */
    ResearchInputIngredient<T> getIngredient(int baseAmount);
     ...
     */
    ResearchInputIngredient<T> setStats(ResearchInputIngredient stats); // TODO
     ...
     */
    ResearchInputIngredient<T> copy();
}